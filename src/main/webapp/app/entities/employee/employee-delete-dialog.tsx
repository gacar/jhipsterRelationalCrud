...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRelationalCrudApp.employee.delete.question">
        <Translate contentKey="jhipsterRelationalCrudApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
