...
export const TaskDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRelationalCrudApp.task.delete.question">
        <Translate contentKey="jhipsterRelationalCrudApp.task.delete.question" interpolate={{ id: taskEntity.id }}>
