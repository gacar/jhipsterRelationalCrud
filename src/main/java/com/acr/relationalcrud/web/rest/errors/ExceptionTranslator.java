package com.acr.relationalcrud.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.acr.relationalcrud.service.EmailAlreadyUsedException ||
            ex instanceof com.acr.relationalcrud.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.acr.relationalcrud.service.InvalidPasswordException
