...
import com.acr.relationalcrud.IntegrationTest;
import com.acr.relationalcrud.domain.Task;
import com.acr.relationalcrud.domain.enumeration.Language;
import com.acr.relationalcrud.repository.TaskRepository;
import com.acr.relationalcrud.service.dto.TaskDTO;
import com.acr.relationalcrud.service.mapper.TaskMapper;
...
class TaskResourceIT {
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).language(DEFAULT_LANGUAGE);
        return task;
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).language(UPDATED_LANGUAGE);
        return task;
    }
    ...
    void putExistingTask() throws Exception {
        ...
        updatedTask.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).language(UPDATED_LANGUAGE);
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).language(UPDATED_LANGUAGE);
